  ...
  return (
    <section id="methodology" className="section" style={{ background: 'var(--navy)' }}>
      <div className="section-inner">
        <SectionHeader eyebrow="How We Deliver" title="Our Engagement Methodology" light />

        <div
          style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '48px 56px', marginTop: '56px' }}
        >
