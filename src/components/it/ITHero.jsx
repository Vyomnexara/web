import { IT_HERO } from '../../constants/it'
...
const ITHero = () => {
  return (
    ...
    >
      ...
      <div className="mx-auto w-full grid-2col relative z-10" style={{ maxWidth: '1200px' }}>
        {/* ── Left column ── */}
        <div className="hero-left">
          ...
          <div className="hero-in flex gap-4 flex-wrap" style={{ '--hero-delay': '360ms' }}>
            ...
            <a href="#contact" className="btn-ghost">Discuss a Project</a>
          </div>
        </div>

        {/* ── Right column: capability pillars ── */}
        <div
        ...
        >
          {IT_HERO.stats.map((stat, i) => (
            <div
              key={i}
              style={{ background: 'rgba(11,27,61,0.6)', padding: '32px 28px', border: '1px solid rgba(197,160,89,0.08)' }}
            >
              <div className="font-cormorant" style={{ fontSize: 'clamp(28px, 3vw, 40px)', fontWeight: 700, color: 'var(--gold)', lineHeight: 1.05 }}>
                {stat.number}
              </div>
