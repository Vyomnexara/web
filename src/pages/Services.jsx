      ...
      <section style={{ background: 'var(--navy)', padding: '140px 5% 70px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '14px', lineHeight: 1.8, color: 'rgba(255,255,255,0.65)', maxWidth: '640px' }}>
            Corporate advisory, company secretarial, corporate legal, compliance, banking and cross-border services under one roof — supporting the full business lifecycle, from incorporation to fundraising and beyond.
          </p>
        </div>
      </section>
        ...
        <div className="section-inner">
          ...
          >
            ...
            >
              ...
              <ul className="flex flex-col" style={{ gap: '8px', listStyle: 'none' }}>
                {['Retainer and Virtual Company Secretary', 'Monthly compliance management', 'Compliance calendars and dashboards'].map(item => (
                  <li key={item} style={{ fontSize: '13px', color: 'var(--charcoal)', paddingLeft: '16px', position: 'relative', lineHeight: 1.6 }}>
                    <span style={{ position: 'absolute', left: 0, top: '10px', width: '6px', height: '1px', background: 'var(--gold)' }} />
                    {item}
                  </li>
            ...
            >
              ...
              <ul className="flex flex-col" style={{ gap: '8px', listStyle: 'none' }}>
                {['Project mandates and corporate events', 'Advisory and structuring opinions', 'Transactional and event based filings'].map(item => (
                  <li key={item} style={{ fontSize: '13px', color: 'var(--charcoal)', paddingLeft: '16px', position: 'relative', lineHeight: 1.6 }}>
                    <span style={{ position: 'absolute', left: 0, top: '10px', width: '6px', height: '1px', background: 'var(--gold)' }} />
                    {item}
                  </li>
